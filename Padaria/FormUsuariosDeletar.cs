...
namespace Padaria
{
    public partial class FormUsuariosDeletar : Form
    {
        public FormUsuariosDeletar()
        {
            InitializeComponent();
        }

        private void FormUsuariosDeletar_Load(object sender, EventArgs e)
        {
            OcultaCampos();
            Preenchercbox();
        }
        ...
        private void btnDeletar_Click(object sender, EventArgs e)
        {
            if (usuarioSelecionado != null) 
            {
                if (OperadorBLL.DeletaUsuario(usuarioSelecionado.Id)) 
                {
                    MessageBox.Show("Usuário deletado com sucesso!");
                }
                else 
                {
                    MessageBox.Show("Não foi possivel deletar o usuário");
                }
            }
            else 
            {
