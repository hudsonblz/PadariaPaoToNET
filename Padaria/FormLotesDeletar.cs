...
namespace Padaria
{
    public partial class FormLotesDeletar : Form
    {
        public FormLotesDeletar()
        {
            InitializeComponent();
        }
        private void FormLotesDeletar_Load(object sender, EventArgs e)
        {
        ...
        private void btnDeletar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (OperadorBLL_Lote.deletaLote(LoteSelecionado.Id))
                {
                ...
                {
                    MessageBox.Show("Falha ao deletar o lote!");
                }
            }
            else
            {
                MessageBox.Show("Selecione um lote para ser deletado!");
            }
        }
