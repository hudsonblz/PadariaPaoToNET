...
namespace Padaria
{
    public partial class FormProdutosDeletar : Form
    {
        public FormProdutosDeletar()
        {
            InitializeComponent();
        }
        private void FormProdutosDeletar_Load(object sender, EventArgs e)
        {
            OcultarCampos();
            PreencherCbox();
        }
        ...
        private void btnDeletar_Click(object sender, EventArgs e)
        {
            if (ProdutoSelecionado != null) 
            {
                if (OperadorBLL.DeletaProduto(ProdutoSelecionado.Id)) 
                {
                ...
                {
                    MessageBox.Show("Falha ao deletar produto");
                }
            }
            else
            {
                MessageBox.Show("Selecione um produto para ser deletado");
            }
        }
